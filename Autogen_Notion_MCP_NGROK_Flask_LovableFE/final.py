...
## Power Shell
# Invoke-WebRequest -Uri "http://localhost:7001/run" `
#     -Method POST `
...
from flask_cors import CORS# https://developers.notion.com/docs/get-started-with-mcp
...
NGROK_AUTH_TOKEN = '30tV6mN2u7lhOTM432D5GToBw31_5QbAi3RB5XZb7Rw8bJTfi' #os.getenv("NGROK_AUTH_TOKEN")
